...
#else
#error "SSD1309 library was tested only on STM32F0, STM32F1, STM32F3, STM32F4, STM32F7, STM32L0, STM32L1, STM32L4, STM32H7, STM32G0, STM32G4, STM32WB MCU families. Please modify ssd1309.h if you know what you are doing. Also please send a pull request if it turns out the library works on other MCU's as well!"
#endif
...
#define SSD1309_DC_Pin          GPIO_PIN_14
#endif

#ifndef SSD1309_Reset_Port
#define SSD1309_Reset_Port      GPIOA
#endif
#ifndef SSD1309_Reset_Pin
#define SSD1309_Reset_Pin       GPIO_PIN_8
#endif

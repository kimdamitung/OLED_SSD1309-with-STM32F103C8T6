...
void ssd1309_TestBorder() {
    ...
    do {
        ...
        if((y == 0) && (x < (SSD1309_WIDTH-1)))
            x++;
        else if((x == (SSD1309_WIDTH-1)) && (y < (SSD1309_HEIGHT-1)))
            y++;
...
void ssd1309_TestFonts2() {
    ...
    ssd1309_SetCursor(0, 4);
    ssd1309_WriteString("18.092.5", Font_16x26, White);
    ssd1309_SetCursor(0, 4+24+8);
    ssd1309_WriteString("RIT+1000", Font_16x26, White);
    ...
    x2 = x1+16;
    y2 = y1+2;
    ssd1309_FillRectangle(x1, y1, x2, y2, White);
...
void ssd1309_TestRectangleFill() {
  ssd1309_FillRectangle(31, 1, 65, 35, White);
  ssd1309_FillRectangle(10, 45, 70, 60, White);
  ssd1309_FillRectangle(75, 10, 100, 45, White);
  ssd1309_FillRectangle(55, 30, 80, 55, Black);
  ssd1309_UpdateScreen();
}
...
void ssd1309_TestCircle() {
  ...
  for(delta = 0; delta < 5; delta ++) {
    ssd1309_FillCircle(23*delta+15, 40, 10, White);
  }
